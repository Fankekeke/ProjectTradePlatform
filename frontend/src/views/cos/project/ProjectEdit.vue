      ...
      <a-row :gutter="15">
        <a-col :span="12">
          <a-form-item label='产品名称'>
            <a-input v-decorator="['proName', { rules: [{ required: true, message: '请输入名称!' }] }]"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='产品价格'>
            <a-input-number :min="0" :step="0.1" style="width: 100%" v-decorator="['proPrice']"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='项目作者'>
            <a-input v-decorator="['authorName', { rules: [{ required: true, message: '请选择作者!' }] }]"
                     @click="childrenDrawer = true"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='服务器机'>
            <a-input v-decorator="['proDownloadUrl']"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label='技术方案'>
            <a-input v-decorator="['proTechnology']"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="24">
          <a-form-item label='产品介绍'>
            <a-textarea :rows="4" v-decorator="['proIntroduce']"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          ...
          <a-form-item label='上传视频'>
            ...
            >
              <a-button :disabled="videoFileList.length >= 1" style="width: 100%">
                <a-icon type="upload"/>
                Upload
              </a-button>
            </a-upload>
        ...
        <a-col :span="24">
          ...
          <a-form-item label='项目文件'>
            ...
            >
              <a-button :disabled="zipFileList.length >= 1" style="width: 100%">
                <a-icon type="upload"/>
                Upload
              </a-button>
            </a-upload>
          ...
          <a-popover v-if="record.avatar !== null">
            <template slot="content">
              <a-avatar shape="square" :size="132" icon="user"
                        :src="'http://127.0.0.1:9528/imagesWeb/' + record.avatar"/>
